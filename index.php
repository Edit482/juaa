<?php
ob_start();
define('API_KEY','271262451:AAHLpDZ4LsHiZz8xrj2CznS3SEaj-TxU0zs');
$admin = "139374223";
...
".$jsu;
  ...
  bot('sendmessage',[
    ...
    'reply_markup'=>json_encode([
      'inline_keyboard'=>[
        [
          ['text'=>'SUDO','url'=>'https://telegram.me/im_pv']
        ],
        [
          ['text'=>'Admin','url'=>'https://telegram.me/MaKeRMaN']
        ]
      ]
    ])
  ]);
